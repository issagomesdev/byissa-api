...
export class CreateRelations1748897020440 implements MigrationInterface {
    name = 'CreateRelations1748897020440'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`project\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`content\` longtext NULL, \`imageUrl\` varchar(255) NULL, \`repositoryLink\` varchar(255) NULL, \`demoLink\` varchar(255) NULL, \`orderNumber\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
