...
export class CreateData1754340496346 implements MigrationInterface {
    name = 'CreateData1754340496346'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`projects\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` mediumtext NOT NULL, \`imageUrl\` varchar(255) NULL, \`repositoryLink\` varchar(255) NULL, \`demoLink\` varchar(255) NULL, \`orderNumber\` int NOT NULL DEFAULT '0', \`content_file\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
